...
namespace Com.Reseul.ASA.Samples.WayFindings
{
    ...
    public class RouteGuideInformation : MonoBehaviour
    {
        ...
        /// <summary>
        ///     アンカーの種別（Virtual Semantic）を表す定数
        /// </summary>
        public const string ANCHOR_TYPE_VSE = "VSE";

        /// <summary>
        ///     アンカーの種別（Same Floor Landmark）を表す定数
        /// </summary>
        public const string ANCHOR_TYPE_SF = "SF";

        /// <summary>
        ///     アンカーの種別（Different Floor Landmark）を表す定数
        /// </summary>
        public const string ANCHOR_TYPE_DF = "DF";
